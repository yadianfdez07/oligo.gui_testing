...
using System.Windows.Forms; //chapter 11
...
namespace GUITestLibrary
{
	public class GUITestUtility
	{
		...
		//Chapter 13		
		public static ControlTestBench StartControlUT(string applicationPath, string typeName)
		{
			Control ctrlUT = (Control)StartAUT(applicationPath, typeName);
			ControlTestBench CTB = new ControlTestBench();
			CTB.Controls.Add(ctrlUT);
			return CTB;
		}
		...
		[Serializable]public struct GUIInfo
		{
			...
			public string TextEntry; //chapter 10
		}
