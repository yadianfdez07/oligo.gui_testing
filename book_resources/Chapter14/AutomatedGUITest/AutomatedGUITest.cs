...
namespace AutomatedGUITest
{
	...
	public class frmMain : System.Windows.Forms.Form
	{
		...
		private System.Windows.Forms.PictureBox pbProbe;
		...
		private void InitializeComponent()
		{
			...
			this.pbProbe = new System.Windows.Forms.PictureBox();
			...
			this.pbProbe.Image = ((System.Drawing.Image)(resources.GetObject("pbProbe.Image")));
			this.pbProbe.Location = new System.Drawing.Point(183, 53);
			...
			this.pbProbe.MouseUp += new System.Windows.Forms.MouseEventHandler(this.pbProbe_MouseUp);
			this.pbProbe.MouseMove += new System.Windows.Forms.MouseEventHandler(this.pbProbe_MouseMove);
			this.pbProbe.MouseDown += new System.Windows.Forms.MouseEventHandler(this.pbProbe_MouseDown);
			// 
			// frmMain
			// 
			this.AutoScaleBaseSize = new System.Drawing.Size(5, 13);
			this.ClientSize = new System.Drawing.Size(544, 362);
			this.Controls.Add(this.pbProbe);
		...
		private void btnGUISurvey_Click(object sender, System.EventArgs e)
		{
			...
			guiSurveyCls.StartMenuSurvey(); //Chapter 12
			SetGUIListToTest();
		...
		private void dgAvailableGUIs_DoubleClick(object sender, System.EventArgs e)
		{
			...
			if (GUITDC.ShowDialog() == DialogResult.OK)
			{
				...
				//chapter 10
				AddTextEntryStep(GUITDC.guiInfo, GUITDC, ref GUISequence, TypesToVerify);
			}
		}
		...
		private void pbProbe_MouseDown(object sender, System.Windows.Forms.MouseEventArgs e)
		{
			isDown = true;
		}
