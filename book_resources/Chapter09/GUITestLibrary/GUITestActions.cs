...
namespace GUITestLibrary
{
	...
	public class GUITestActions
	{
		...
		public static void HandleListBox(ref int hwnd, ref string winText, ref string clsName, ref string pText)
		{
		...
		public static void HandleTextBox(ref int hwnd, ref string winText, ref string clsName, ref string pText)
		{
			int r = FindGUILike(ref hwnd, 0, ref winText, ref clsName, ref pText);
		...
		public static void HandleCommandButton(ref int hwnd, ref string winText, ref string clsName, ref string pText)
		{
		...
		//Chapter 9
		public static void HandleCosmeticGUIs(ref int hwnd, ref string winText, ref string clsName, ref string pText)
		{
